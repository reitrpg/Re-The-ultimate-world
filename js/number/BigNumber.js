...
class BigNumber {
    ...
    static from(value) {
        ...
        return new BigNumber(Number(value) || 0, 0);
    }
    ...
    add(value) {
        const other = BigNumber.from(value);
        const result = add(this, other);
        return new BigNumber(result.mantissa, result.exponent);
    }

    subtract(value) {
        const other = BigNumber.from(value);
        const result = subtract(this, other);
        return new BigNumber(result.mantissa, result.exponent);
    }

    multiply(value) {
        const other = BigNumber.from(value);
        const result = multiply(this, other);
        return new BigNumber(result.mantissa, result.exponent);
    }

    divide(value) {
        const other = BigNumber.from(value);
        const result = divide(this, other);
        return new BigNumber(result.mantissa, result.exponent);
    }
    ...
    toNumber() {
        return this.mantissa * Math.pow(1000, this.exponent);
    }
